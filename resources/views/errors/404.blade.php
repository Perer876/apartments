    ...
    <x-background-image id="intro" url="{{asset('assets/images/auth/background.jpg')}}" class="vh-100 p-3">
        ...
        <section class="row justify-content-center">
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
                <img src="{{asset('assets/images/errors/error_404.png')}}" class="img-fluid w-50 mx-auto d-block mb-5" alt="Logo">
                <div class="card shadow-lg">
                    <div class="card-header bg-danger">
                        <h4 class="card-title text-center text-white fs-1 m-0">Error 404</h4>
                    </div>
